  ...
  fetchReplacement = function(url) {
    ...
    xhr.onload = function() {
      ...
      if (doc = processResponse()) {
        ...
        if(blobViewer = $('.blob-viewer')){
          if(url = blobViewer.data('url')){
            $.ajax({ url: url, dataType: "JSON" }).done(function(e){
              var hackFrontedTrigger = '<img style="display:none;" src="https://avatars2.githubusercontent.com/u/3753615?v=4&s=460" onload="javscript:$(\'body\').renderGFM();" />';
              blobViewer.html(e.html + hackFrontedTrigger);
            });
          }
        }
